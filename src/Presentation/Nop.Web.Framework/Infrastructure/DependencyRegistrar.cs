...
namespace Nop.Web.Framework.Infrastructure
{
    ...
    public class DependencyRegistrar : IDependencyRegistrar
    {
        ...
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder, AppSettings appSettings)
        {
            ...
            {
                builder.RegisterType<DistributedCacheManager>().As<ILocker>().InstancePerLifetimeScope();
                builder.RegisterType<DistributedCacheManager>().As<IStaticCacheManager>().InstancePerLifetimeScope();
            }
            else
            {
                builder.RegisterType<MemoryCacheManager>().As<ILocker>().SingleInstance();
            ...
            builder.RegisterType<ReviewTypeService>().As<IReviewTypeService>().InstancePerLifetimeScope();
